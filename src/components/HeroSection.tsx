    ...
    >
          ...
          <div className="order-2 flex flex-col gap-8">
            ...
            >
              ...
              <span className="text-[#8C5A3C]">
                ...
                <span
                  className={`font-light transition-opacity duration-100 ${showCursor ? "opacity-100" : "opacity-0"
                    }`}
                >
                  |
                </span>
            ...
            <p
              ref={subtextRef}
              className="text-lg lg:text-xl font-bold text-muted-foreground max-w-lg leading-relaxed"
            >
            ...
            <div ref={ctaRef} className="flex flex-wrap gap-4">
              <Button
                size="lg"
                className="bg-[#8C5A3C] text-white hover:bg-[#7A4E34] rounded-full px-8 text-base font-semibold"
              >
                Explore Designs
              </Button>
              <Button
      ...
      <div className="fixed bottom-8 right-8 z-[100] flex items-center justify-center">
        ...
        <div className="absolute right-[100%] flex items-center mr-4 cursor-default animate-in fade-in duration-500 pointer-events-none">
          <div className="bg-white text-gray-800 text-[15px] font-medium px-5 py-2.5 rounded-[12px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] whitespace-nowrap">
            Contact Us
          </div>
        ...
        {/* WhatsApp Core Button */}
        <a
          href="https://wa.me/"
          target="_blank"
          rel="noopener noreferrer"
          className="relative bg-[#25D366] text-white p-4 rounded-full shadow-lg transform transition-transform duration-300 hover:scale-105 active:scale-95 flex items-center justify-center cursor-pointer"
